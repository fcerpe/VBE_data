...
opt.subjects = {'018'}; % 002 003 004 005
...
opt.results(3).nodeName = 'run_level';
...
opt.results(4).nodeName = 'run_level';
...
opt.results(5).nodeName = 'run_level';
...
opt.results(6).nodeName = 'run_level';
...
opt.results(7).nodeName = 'run_level';
...
opt.results(8).nodeName = 'run_level';
...
opt.results(9).nodeName = 'run_level';
