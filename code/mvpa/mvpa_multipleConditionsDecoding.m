function accu = mvpa_multipleConditionsDecoding(opt)
...
savefileMat = fullfile(opt.dir.cosmo, ...
    ['multiple-decoding-', opt.decodingCondition{1} ,'_grp-', opt.groupName{1}, '_rois-', opt.roiMethod, ...
...
% analyses
[condLabelName, decodingCondition, condLabelNb, decodingGroups] = mvpa_assignDecodingConditions(opt);
