    ...
    switch opt.roiMethod
        case 'general_coords_10mm'
            opt.maskName = horzcat(opt.maskName, ...
                ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-NeurosynthCoords_label-VWFAbr_radius-10mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-NeurosynthCoords_label-lLO_radius-10mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-NeurosynthCoords_label-lpFS_radius-10mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-NeurosynthCoords_label-rLO_radius-10mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-NeurosynthCoords_label-rpFS_radius-10mm_mask.nii') ...
                });
        ...
        case 'anatomical_intersection_8mm'
                ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-AnatIntersection_label-VWFAbr_radius-8mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-AnatIntersection_label-lLO_radius-8mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-AnatIntersection_label-lpFS_radius-8mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-AnatIntersection_label-rLO_radius-8mm_mask.nii'), ...
                strcat('rsub-', num2str(subID), '_space-MNI_trial-AnatIntersection_label-rpFS_radius-8mm_mask.nii') ...
                });
