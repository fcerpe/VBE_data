...
for i = 1:length(subs)
    ...
    switch subs{i}
        ...
        case '002' % SUB-002
            ...
            mni{i}(4, 1:3) = [4.680000e+01, -7.040000e+01, -0.500000e+01];  %  LO RIGHT
...
%             mni{i}(6, 1:3) = [4.160000e+01, -6.520000e+01, -1.540000e+01];  % PFS RIGHT
        ...
        case '003' % SUB-003
            ...
            mni{i}(4, 1:3) = [4.420000e+01, -8.080000e+01, -0.500000e+01];  %  LO RIGHT
...
%             mni{i}(6, 1:3) = [3.100000e+01, -4.700000e+01, -2.060000e+01];  % PFS RIGHT
        ...
        case '005' 
            ...
            mni{i}(4, 1:3) = [ 3.640000e+01, -8.340000e+01, -1.020000e+01];  %  LO RIGHT
...
%             mni{i}(6, 1:3) = [ 3.640000e+01, -5.220000e+01, -1.280000e+01];  % PFS RIGHT
        ...
        case '006'
            ...
            mni{i}(4, 1:3) = [ 3.900000e+01 -6.780000e+01 -1.020000e+01];  %  LO RIGHT
%             mni{i}(4, 1:3) = [-4.160000e+01 -5.480000e+01 -1.540000e+01];  % PFS LEFT
%             mni{i}(6, 1:3) = [ 3.640000e+01 -4.700000e+01 -2.320000e+01];  % PFS RIGHT

        case '007'
            mni{i}(1, 1:3) = [-5.200000e+01 -4.960000e+01 -1.800000e+01];  % VWFA FRE
            mni{i}(2, 1:3) = [-5.200000e+01 -4.960000e+01 -1.800000e+01];  % VWFA BRA
            mni{i}(3, 1:3) = [-4.420000e+01 -6.520000e+01 -1.280000e+01];  %  LO LEFT
            mni{i}(4, 1:3) = [ 4.680000e+01 -7.820000e+01  0.020000e+01];  %  LO RIGHT
%             mni{i}(4, 1:3) = [-3.640000e+01 -4.700000e+01 -2.320000e+01];  % PFS LEFT
%             mni{i}(6, 1:3) = [ 3.900000e+01 -5.220000e+01 -2.060000e+01];  % PFS RIGHT

        case '008'
            mni{i}(1, 1:3) = [-5.200000e+01 -5.480000e+01 -1.800000e+01];  % VWFA FRE
            mni{i}(2, 1:3) = [NaN NaN NaN];                                % VWFA BRA
            mni{i}(3, 1:3) = [-4.160000e+01 -7.820000e+01 -0.240000e+01];  %  LO LEFT
            mni{i}(4, 1:3) = [ 4.420000e+01 -7.820000e+01 -0.760000e+01];  %  LO RIGHT
%             mni{i}(4, 1:3) = [-3.640000e+01 -5.480000e+01 -2.060000e+01];  % PFS LEFT
%             mni{i}(6, 1:3) = [ 3.640000e+01 -4.960000e+01 -2.320000e+01];  % PFS RIGHT

        case '009'
            mni{i}(1, 1:3) = [-4.420000e+01 -6.260000e+01 -1.280000e+01];  % VWFA FRE
            mni{i}(2, 1:3) = [-4.160000e+01 -6.260000e+01 -1.020000e+01];  % VWFA BRA
            mni{i}(3, 1:3) = [-4.940000e+01 -7.820000e+01 -0.240000e+01];  %  LO LEFT
            mni{i}(4, 1:3) = [ 3.640000e+01 -7.040000e+01 -1.280000e+01];  %  LO RIGHT
%             mni{i}(4, 1:3) = [-4.680000e+01 -4.960000e+01 -1.800000e+01];  % PFS LEFT
%             mni{i}(6, 1:3) = [ 3.900000e+01 -5.740000e+01 -1.540000e+01];  % PFS RIGHT

        case '012'
            mni{i}(1, 1:3) = [-4.420000e+01 -6.000000e+01 -1.540000e+01];  % VWFA FRE
            mni{i}(2, 1:3) = [-4.420000e+01 -5.740000e+01 -1.800000e+01];  % VWFA BRA
            mni{i}(3, 1:3) = [-4.940000e+01 -7.560000e+01 -0.500000e+01];  %  LO LEFT
            mni{i}(4, 1:3) = [ 4.940000e+01 -7.300000e+01 -1.020000e+01];  %  LO RIGHT

        case '013'
            mni{i}(1, 1:3) = [-4.420000e+01 -6.000000e+01 -1.280000e+01];  % VWFA FRE
            mni{i}(2, 1:3) = [-4.680000e+01 -6.260000e+01 -1.540000e+01];  % VWFA BRA
            mni{i}(3, 1:3) = [-4.940000e+01 -7.820000e+01 -0.240000e+01];  %  LO LEFT
            mni{i}(4, 1:3) = [ 4.940000e+01 -6.780000e+01 -1.280000e+01];  %  LO RIGHT
