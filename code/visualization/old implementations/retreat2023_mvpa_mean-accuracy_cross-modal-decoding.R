...
ggplot(data = subset(stats, modality != "both" & mask == "VWFA"), aes(x = decodingCondition, y = mean_accuracy)) + 
  ...
  geom_point(data = subset(experts, modality != "both" & mask == "VWFA"),
...
ggsave("figures/lbp-retreat_crossmodal-decoding_mean-accuracy.png", width = 3000, height = 1800, dpi = 320, units = "px")
